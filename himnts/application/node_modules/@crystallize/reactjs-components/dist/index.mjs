...
var Renderers = {
  ...
  heading4: (props) => /* @__PURE__ */ jsx("h4", { children: /* @__PURE__ */ jsx(NodeContent, { ...props }) }),
  heading5: (props) => /* @__PURE__ */ jsx("h5", { children: /* @__PURE__ */ jsx(NodeContent, { ...props }) }),
  heading6: (props) => /* @__PURE__ */ jsx("h6", { children: /* @__PURE__ */ jsx(NodeContent, { ...props }) }),
...
var ContentTransformer = ({ overrides = null, json }) => {
  ...
  if (Array.isArray(json)) {
    const nodes = json;
    return /* @__PURE__ */ jsx(Fragment, { children: nodes.map((j, i) => /* @__PURE__ */ jsx(ContentTransformerNode, { ...j, overrides }, i)) });
  }
  const node = json;
  return /* @__PURE__ */ jsx(ContentTransformerNode, { ...node, overrides });
};
